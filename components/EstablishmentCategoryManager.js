// components/EstablishmentCategoryManager.js - GERENCIADOR DE CATEGORIAS DE ESTABELECIMENTOS
...
import EstablishmentCategoryList from './EstablishmentCategoryList';
import EstablishmentCategoryFormWithPreview from './EstablishmentCategoryFormWithPreview';

export default function EstablishmentCategoryManager({ navigation }) {
  ...
  return (
    ...
    >
      ...
      >
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerTitleContainer}>
            ...
            <Text style={styles.headerSubtitle}>Gerenciar categorias de estabelecimentos</Text>
          </View>
      ...
      {/* Modal de formulário */}
      <EstablishmentCategoryFormWithPreview
        visible={showForm}
